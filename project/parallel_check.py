...
# MAP
print("MAP")
tmap = minitorch.fast_ops.tensor_map(njit()(minitorch.common_operators.id))
...
tzip = minitorch.fast_ops.tensor_zip(njit()(minitorch.common_operators.eq))
...
treduce = minitorch.fast_ops.tensor_reduce(njit()(minitorch.common_operators.add))
